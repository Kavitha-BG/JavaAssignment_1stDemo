...
//	chr
	...
	public ArrayList<Book> AddBook(ArrayList bookList) {
		...
		Book b = new Book(Book_Code, book_Name, author, subject, issue_Status, issued_to, null ,null);
		bookList.add(b);
	...
	public ArrayList<User> AddUser(ArrayList userList) throws IOException {
		...
		User u = new User(name, user_Id, issued_Book_Id, null, null );
		userList.add(u);
	...
	public void ViewBooksList (ArrayList bookList ) {
		...
		Iterator itr = bookList.iterator(); 
			  while(itr.hasNext()){  
				    ...
				    System.out.printf(obj.getBook_Code(), obj.getBook_Name(), obj.getAuthor(), obj.getSubject(), obj.getIssue_Status(), obj.getIssued_to(), obj.getIssued_Date(), obj.getReturn_Date());
			  }  
	}
        ...
        try {
            ...
            while ((str = br.readLine()) != null) {
                ...
                if (split[4].equals("null")) {
                	...
                	try {
                		localDateTime = LocalDateTime.parse(split[4],formatter);
                	} 
                	catch(Exception e) {
                		System.out.println(e);
                	}
                ...
                if (split[5].equals("null")) {
                    ...
                    localDateTime1 = LocalDateTime.parse(split[5],formatter);
                }
                User u2 = new User(split[0], split[1], split[3], localDateTime, localDateTime1);
                userlist.add(u2);
            }
        } catch (ArrayIndexOutOfBoundsException | IOException e) {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		while(true) {
			...
			ArrayList bookList = s.read();
			ArrayList userLists = s.read2();
				...
				case 2: sc.nextLine();
					...
					while(true) {
						...
						for(int i=0; i < userLists.size(); i++) {
							buffer.write(userLists.get(i).toString() + "\n");
						}
						buffer.write("\n");
						buffer.close();
					...
					break;
				case 3: 
					s.ViewBooksList(bookList);
					break;
				case 4: 
					s.ViewByBookCode(bookList);
					break;
				case 5:sc.nextLine();
					main:
					while(true) {
						String a;
						bookList = s.DeleteBookByBookCode(bookList);
